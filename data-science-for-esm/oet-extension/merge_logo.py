...
logo_TU = Image.open("data-science-for-esm/logo.png")
logo_OET = Image.open("data-science-for-esm/oet-extension/logo_OET.png")
logo_I = Image.open("data-science-for-esm/logo_int.png")

logo_C = create_contribution_image(logo_TU, logo_OET)
logo = merge_institue_image(logo_C, logo_I)

logo.save("data-science-for-esm/logo_merged.png")
